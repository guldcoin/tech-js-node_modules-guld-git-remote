...
describe('get-git-remote', function () {
  ...
  it('createRemote all', async function () {
    ...
    assert.equal(cfg['remote "guld"'].pushurl[0], 'https://bitbucket.org/guld/test-repo.git')
    assert.equal(cfg['remote "guld"'].pushurl[1], 'https://github.com/guldcoin/test-repo.git')
    assert.equal(cfg['remote "guld"'].pushurl[2], 'https://gitlab.com/guld/test-repo.git')
  })
  it('addRemote', async function () {
    ...
    assert.equal(cfg['remote "guld"'].pushurl[0], 'https://bitbucket.org/guld/tech-js-node_modules-guld-git-remote.git')
    assert.equal(cfg['remote "guld"'].pushurl[1], 'https://github.com/guldcoin/tech-js-node_modules-guld-git-remote.git')
    assert.equal(cfg['remote "guld"'].pushurl[2], 'https://gitlab.com/guld/tech-js-node_modules-guld-git-remote.git')
  })
